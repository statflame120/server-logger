...
public abstract class Widget {
    ...
    // ── Layout Anchoring ─────────────────────────────────────────────────────
    public enum Anchor {
        NONE,         // absolute / vertical-stack positioning (legacy)
        FILL,         // fill entire parent content area
        TOP,          // anchored to top, full width, fixed height
        BOTTOM,       // anchored to bottom, full width, fixed height
        FILL_ABOVE,   // fill space above a bottom margin
        FILL_BELOW,   // fill space below a top margin
        BOTTOM_RIGHT  // fixed size, anchored to bottom-right corner
    }
     ...
     * and the given parent content bounds. Pure arithmetic, no side effects.
     */
