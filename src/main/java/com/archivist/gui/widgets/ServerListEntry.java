 ...
 *
 * Layout per row (44px tall):
 * +------------------------------------------------------------------+
 * |  mc.example.com:25565                          13 plugins         |
 * |  Paper 1.20.4 | Last: 2025-01-15   | 3 sessions                  |
 * +------------------------------------------------------------------+
 */
public class ServerListEntry extends Widget {
    ...
    public void render(GuiGraphics g, int mouseX, int mouseY, float delta) {
        ...
        // Line 1: server address (left) + plugin count (right)
        ...
        // Line 2: brand + version | last visited | session count
