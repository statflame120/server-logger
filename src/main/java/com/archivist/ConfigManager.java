...
public class ConfigManager {
    ...
    private static final Path CONFIG_PATH =
            FabricLoader.getInstance().getConfigDir().resolve("archivist.json");

    public boolean enabled       = true;
    public String  logFolder     = "archivist/server-logs";
    ...
    public void load() {
        ...
        try (Reader r = Files.newBufferedReader(CONFIG_PATH)) {
            ...
            ArchivistMod.sendMessage("Failed to load config: " + e.getMessage());
        }
    }
    ...
    public void save() {
        try {
            ...
            ArchivistMod.sendMessage("Failed to save config: " + e.getMessage());
        }
    }
}
